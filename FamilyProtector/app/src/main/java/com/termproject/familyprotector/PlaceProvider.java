...
public class PlaceProvider extends ContentProvider{
    public static final String BASE_URI = "com.termproject.familyprotector.PlaceProvider";
    public static final Uri SEARCH_URI = Uri.parse("content://"+BASE_URI+"/search");
    public static final Uri DETAILS_URI = Uri.parse("content://"+BASE_URI+"/details");

    private static final int SEARCH = 1;
    private static final int SUGGESTIONS = 2;
    private static final int DETAILS = 3;

    String apiKey = "key=AIzaSyBTA9R3hjm618utMuwOkN1FYM_ykKE1Wo8";
    ...
    private static UriMatcher buildUriMatcher(){
        ...
        // URI for "Go" button
        uriMatcher.addURI(BASE_URI, "search", SEARCH );

        // URI for suggestions in Search Dialog
        uriMatcher.addURI(BASE_URI, SearchManager.SUGGEST_URI_PATH_QUERY,SUGGESTIONS);

        // URI for Details
        uriMatcher.addURI(BASE_URI, "details",DETAILS);
        ...
        switch (mUriMatcher.match(uri)){
            case SEARCH:
                ...
                try {
                    ...
                    list = parser.parseJSONObject(new JSONObject(jsonString));
                    ...
                    for(int i=0;i<list.size();i++){
                        ...
                        detailsList = detailsParser.parseJSONObject(new JSONObject(jsonPlaceDetails));
